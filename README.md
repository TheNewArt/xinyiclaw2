...
| 2026-04-03 | "API Error 0:" 错误 — 响应无 base_resp 或 status_code 时处理不当 | 优先检查有效内容再检查状态码，添加异常响应日志 | ✅ 已修复 |
...
|------|------------|------------|------|
| 平均延迟 | 22,492ms | 10,926ms | **+51.4%** |
| 最小延迟 | 4,636ms | 3,926ms | +15.3% |
| 最大延迟 | 42,313ms | 14,134ms | **+66.6%** |
| P50 | 18,969ms | 11,512ms | **+39.3%** |
| 吞吐量 | 0.0 req/s | 0.1 req/s | **+105.9%** |

**结论：**
- 新版平均延迟比旧版快了 **51.4%**
- 最大延迟减少了 **66.6%**，稳定性显著提升
- 吞吐量提升超过 **100%**
